...
const Home = () => {
  ...
  return (
    <div className="w-full m-w-screen scrollbar-hidden relative">
        <Head>
        ...
        <main className="h-full">
            ...
            <section className="container mx-auto flex flex-wrap">
              <div className="flex-1  p-4 lg:p-14 flex flex-col gap-y-6 py-10">
                ...
                <div className="space-x-3 flex flex-shrink-0">
                  <motion.button initial={{ x:-20}} animate={{ x:0 }}  className="bg-white hover:shadow-lg hover:scale-105 transtion duration-300 border-primary items-center px-4 py-2 text-primary shadow-sm flex whitespace-nowrap">
                    Demande d'admission
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z" />
                    </svg>
                  </motion.button>
                  <motion.button initial={{ x:20}} animate={{ x:0 }}  className="bg-white hover:shadow-lg hover:scale-105 transtion duration-300 box-border border border-primary px-4 py-2 text-primary shadow-sm">Connexion</motion.button>
                </div>
              </div>
          ...
          <div className="w-full h-full bg-gray-50">
            <section className="container mx-auto py-14">
              ...
              <motion.div initial="hidden" whileInView="show" variants={variants} className="flex flex-col justify-center items-center mt-10 space-y-4">
                <motion.details variants={items} viewport={{ once:true }} className="w-full cursor-pointer max-w-[80%] lg:max-w-[60%]  transition duration-1000 bg-white p-6 px-4 rounded-sm drop-shadow-md">
