const Footer = () => {
    return(
        <footer className="p-4 bg-primary rounded-t-lg shadow text-white flex items-center justify-between md:p-6 dark:bg-gray-800">
          <span className="text-sm sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">ESP™</a>. All Rights Reserved.
          </span>
